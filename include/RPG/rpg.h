...
typedef enum {
    RPG_TRANSITION_GLITCH_DISPLACE,
    RPG_TRANSITION_DIRECTIONAL_WARP,
    RPG_TRANSITION_LUMINANCE_MELT,
    RPG_TRANSITION_PINWHEEL,
    RPG_TRANSITION_CIRCLE,
    RPG_TRANSITION_LUMA,
    RPG_TRANSITION_RIPPLE,
    RPG_TRANSITION_CURTAIN,
    RPG_TRANSITION_DIRECTIONAL_WIPE,
    RPG_TRANSITION_WATERDROP,
    RPG_TRANSITION_GRID_FLIP,
    RPG_TRANSITION_BURN,
    RPG_TRANSITION_COLOR_PHASE,
    RPG_TRANSITION_SWIRL,
    RPG_TRANSITION_HEART,
    RPG_TRANSITION_HEXAGONALIZE,
    RPG_TRANSITION_SQUARES_WIRE,
    RPG_TRANSITION_WINDOWBLINDS,
    RPG_TRANSITION_STATIC,
    RPG_TRANSITION_DISPLACEMENT,
    RPG_TRANSITION_BOW_TIE_V,
    RPG_TRANSITION_PARAMETRICS,
    RPG_TRANSITION_WIPE_LEFT,
    RPG_TRANSITION_DIRECTIONAL,
    RPG_TRANSITION_WIPE_DOWN,
    RPG_TRANSITION_MORPH,
    RPG_TRANSITION_FADE_GRAYSCALE,
    RPG_TRANSITION_ROTATE_SCALE_FADE,
    RPG_TRANSITION_WIPE_UP,
    RPG_TRANSITION_CROSS_ZOOM,
    RPG_TRANSITION_MOSAIC,
    RPG_TRANSITION_PIXELIZE,
    RPG_TRANSITION_SQUEEZE,
    RPG_TRANSITION_WINDOW_SLICE,
    RPG_TRANSITION_RADIAL,
    RPG_TRANSITION_FADE_COLOR,
    RPG_TRANSITION_SWAP,
    RPG_TRANSITION_KALEIDOSCOPE,
    RPG_TRANSITION_ANGULAR,
    RPG_TRANSITION_DOORWAY,
    RPG_TRANSITION_MULTIPLY_BLEND,
    RPG_TRANSITION_LINEAR_BLUR,
    RPG_TRANSITION_WIPE_RIGHT,
    RPG_TRANSITION_CROSS_WARP,
    RPG_TRANSITION_GLITCH_MEMORIES,
    RPG_TRANSITION_SQUARES,
    RPG_TRANSITION_SIMPLE_ZOOM,
    RPG_TRANSITION_PERLIN,
    RPG_TRANSITION_FLYEYE,
    RPG_TRANSITION_CUBE,
    RPG_TRANSITION_BURNOUT,
    RPG_TRANSITION_PAGE_CURL,
    RPG_TRANSITION_FADE,
    RPG_TRANSITION_FILM_BURN,
    RPG_TRANSITION_DOOM,
    RPG_TRANSITION_CROSSHATCH,
    RPG_TRANSITION_BOUNCE,
    RPG_TRANSITION_CIRCLE_OPEN,
    RPG_TRANSITION_BOW_TIE_H,
    RPG_TRANSITION_DREAMY,
    RPG_TRANSITION_POLAR,
    RPG_TRANSITION_COLOR_DISTANCE,
    RPG_TRANSITION_WIND
} RPG_TRANSITION;
...
RPG_RESULT RPG_Transition_Create(RPG_TRANSITION type, RPGshader **shader);
