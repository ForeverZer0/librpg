...
DEF_FX_PARAM_B(Reverb, DecayLimit, AL_EAXREVERB_DECAY_HFLIMIT, RPG_FALSE, RPG_TRUE)
...
DEF_FX_PARAM_B(Compressor, Enabled, AL_COMPRESSOR_ONOFF, RPG_FALSE, RPG_TRUE)
