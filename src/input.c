...
RPG_RESULT RPG_Input_SetCursorMode(RPG_CURSOR_MODE mode)
{
    switch (mode)
    {
        case RPG_CURSOR_MODE_NORMAL: glfwSetInputMode(RPG_GAME->window, GLFW_CURSOR, GLFW_CURSOR_NORMAL); break;
        case RPG_CURSOR_MODE_HIDDEN: glfwSetInputMode(RPG_GAME->window, GLFW_CURSOR, GLFW_CURSOR_HIDDEN); break;
        case RPG_CURSOR_MODE_DISABLED: glfwSetInputMode(RPG_GAME->window, GLFW_CURSOR, GLFW_CURSOR_DISABLED); break;
...
RPG_RESULT RPG_Input_SetCursorType(RPG_CURSOR shape)
{
    ...
    switch (shape)
    {
        case RPG_CURSOR_ARROW: cursor = glfwCreateStandardCursor(GLFW_ARROW_CURSOR); break;
        case RPG_CURSOR_IBEAM: cursor = glfwCreateStandardCursor(GLFW_IBEAM_CURSOR); break;
        case RPG_CURSOR_CROSSHAIR: cursor = glfwCreateStandardCursor(GLFW_CROSSHAIR_CURSOR); break;
        case RPG_CURSOR_HAND: cursor = glfwCreateStandardCursor(GLFW_HAND_CURSOR); break;
        case RPG_CURSOR_HRESIZE: cursor = glfwCreateStandardCursor(GLFW_HRESIZE_CURSOR); break;
        case RPG_CURSOR_VRESIZE: cursor = glfwCreateStandardCursor(GLFW_VRESIZE_CURSOR); break;
        default: return RPG_ERR_INVALID_VALUE;
    }
